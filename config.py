...
BOT_TOKEN = os.environ.get("BOT_TOKEN", "8669072161:AAHcbLi_ECRBo_8OGXZg4jP-bk1KOdzS074")
# Search Settings
...
# Optional settings
OWNER_ID = int(os.environ.get("OWNER_ID", 6440652367))
ADMINS = [int(x) for x in os.environ.get("ADMINS", "6440652367").split(",") if x]  # multiple admins allowed ("8475661555","8475661555")
